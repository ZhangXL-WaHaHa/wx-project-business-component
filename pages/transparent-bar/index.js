...
Page({
    ...
    data: {
        topImage:
            "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1601294449848&di=def1c297c66d543f503cfa7c351a2bd5&imgtype=0&src=http%3A%2F%2Fimg.icom168.cn%2Fupload%2Fimages%2F7127%2F20200722%2F1595442176946.jpg", //顶部轮播图片
    ...
    onReady: function () {
        ...
        this.createIntersectionObserver()
            .relativeToViewport()
            .observe(".scroll-monitor-line", (res) => {
        ...
        this.createIntersectionObserver()
            .relativeToViewport()
            .observe(".scroll-monitor-line-leave", (res) => {
                if (res.intersectionRatio > 0) {
                    console.log("离开");
                    this.setData({
                        changeOpacity: false,
